...
class Ship(FlyingObject):
    ...
    def goto1(self):
        self.x=650
        self.y=150-self.rect.height/2
        self.dx=-55
        self.dy=55
        self.image = pygame.transform.rotate(self.image0, 135)
    ...
    def goto3(self):
        ...
        self.dx=-55
        self.dy=-55
        self.image = pygame.transform.rotate(self.image0, 45)
    ...
    def update(self, seconds):
        ...
        if self.ziel == 2 and self.lifetime > 0:
            self.goto2()
            #elf.goto(2)
            self.ziel = 3
            
        if self.ziel == 3 and self.lifetime > 7:
            self.goto3()
            #self.goto(3)
            self.ziel =1
            
        if self.ziel == 1 and self.lifetime > 14:
            self.goto1()
            #self.goto(1)
            self.ziel = 2
            self.lifetime = -7
...
class Mothership(Ship):
    ...
    def init2(self):
        ...
        #self.lifetime =-4
        #             nr   x, y, dx, dy, winkel
        self.gotos = {1:(650, 150, -55, 55, 135),
                      2:(250, 550, 100, 0, 270),
                      3:(1050, 550, -55, -55, 45),
                      }
...
class PygView(object):
    ...
    def paint(self):
        ...
        Frigate.groups = self.allgroup, self.shipgroup
        Mothership.groups = self.allgroup, self.shipgroup
        Hunter.groups = self.allgroup, self.shipgroup
        Bomber.groups = self.allgroup, self.shipgroup
        Paladin.groups = self.allgroup, self.shipgroup
        ...
        #self.frigate1 = Frigate (x=150, y=250)
        #self.frigate2 = Frigate (x=250, y=150)
        self.mothership1 = Mothership (x=500, y=400)
        #self.mothership2 = Mothership (x=400, y=500)
        #self.hunter1 = Hunter (x=50, y=100)
        #self.hunter2 = Hunter (x=100, y=50)
        #self.bomber1 = Bomber (x=700, y=600)
        #self.bomber2 = Bomber (x=600, y=700)
        #self.paladin1 = Paladin (x=200, y=100)
        #self.paladin2 = Paladin (x=100, y=200)
    ...
    def run(self):
        ...
        while running:
            ...
            write(self.screen, "FPS: {:6.3}  PLAYTIME:{:6.3} MINUTES:{:6.3} SECONDS".format(
